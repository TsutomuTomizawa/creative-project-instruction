...
フックで1つの訴求型を選定した後、同じ訴求型で異なる切り口のバリエーションを作成することで、より効果的なA/Bテストが可能になります。

#### バリエーション作成の3つの軸

1. **対象の範囲**
   - 個人レベル → チームレベル → 組織レベル → 業界レベル
   - 狭い範囲から広い範囲へ、または逆のアプローチ

2. **時間軸**
   - 即時的リスク → 短期的リスク → 中長期的リスク
   - 現在の問題 → 将来の機会損失

3. **影響の種類**
   - 金銭的損失 → 時間的損失 → 機会損失 → 信頼損失
   - 定量的影響 → 定性的影響
...
**バリエーション展開例：SaaS製品の場合**

```
バリエーションA：業界全体のリスク訴求
「業界の7割が既にデジタル化完了。取り残される前に」
→ 競争環境の変化による脅威を強調
...
バリエーションC：競合比較リスク訴求
「競合A社は既に30%の効率化を達成。この差は致命的」
→ 具体的な競合との差を明示

バリエーションD：将来的な機会損失訴求
「今始めないと、3年後には追いつけない差に」
→ 時間経過による影響の拡大を警告
